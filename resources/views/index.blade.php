...
<body>
    ...
    <section class="header" id="header">
        ...
        <div class="container">
            <div class="hero">
                <h2>Kota Medan</h2>
                <p>Merupakan kota terbesar di Indonesia setelah jakarta dan Surabaya, serta kota terbesar di luar Pulau Jawa.</p>
                <a href="https://pemkomedan.go.id/" class="btn btn-light mr-3">Jelajah</a>
            </div>
        </div>
    </section>
